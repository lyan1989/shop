    ...
    d.extend(L.prototype, {markerClassName: "hasDatepicker", log: function () {
        ...
        _connectDatepicker: function (a, b) {
            ...
            if (c == "button" || c == "both") {
                ...
                b.trigger = d(this._get(b, "buttonImageOnly") ? d("<img/>").addClass(this._triggerClass).attr({src: f, alt: c, title: c}) : d('<button type="button"></button>').addClass(this._triggerClass).base(f ==
        ...
        _enableDatepicker: function (a) {
            ...
            if (!(d(e).hasClass(this._unselectableClass) || this._isDisabledDatepicker(f[0]))) {
                f = this._getInst(f[0]);
                f.selectedDay = f.currentDay = d("a", e).base();
