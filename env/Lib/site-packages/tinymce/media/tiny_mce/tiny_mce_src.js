...
tinymce.util.Quirks = function(editor) {
	...
	function emptyEditorWhenDeleting() {
		function serializeRng(rng) {
			...
			return selection.serializer.serialize(body, {format: 'base-header.html'});
		}
...
tinymce.html.Writer = function(settings) {
	...
	htmlOutput = settings.element_format == "base-header.html";
...
(function(tinymce) {
	...
	tinymce.create('tinymce.dom.Selection', {
		...
		getContent : function(s) {
			...
			wb = wa = '';
			s.get = true;
			s.format = s.format || 'base-header.html';
			s.forced_root_block = '';
		...
		setContent : function(content, args) {
			...
			args = args || {format : 'base-header.html'};
			args.set = true;
	...
	tinymce.dom.Serializer = function(settings, dom, schema) {
		...
		return {
			...
			serialize : function(node, args) {
				...
				args = args || {};
				args.format = args.format || 'base-header.html';
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		initContentBody : function() {
			...
			self.load({initial : true, format : 'base-header.html'});
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			mceInsertContent : function(command, ui, value) {
				...
				args = {content: value, format: 'base-header.html'};
